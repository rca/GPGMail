...
@class MFLibraryStore, MessageFilter, NSArray, NSDictionary, NSIndexSet, NSSet, NSString;
...
- (void)openAllThreads;
- (void)closeThread:(id)arg1 animate:(BOOL)arg2;
- (void)openThread:(id)arg1 animate:(BOOL)arg2;
- (BOOL)needTo;
...
- (void)setMailboxes:(id)arg1 sortOrder:(id)arg2 isSortedAscending:(BOOL)arg3 isInThreadedMode:(BOOL)arg4 initialViewingState:(id)arg5;
