...
@interface DocumentEditor : NSObject <NSToolbarDelegate, ImageResizerDelegate, MailFullScreenWindowDelegate, MCActivityTarget, MVTerminationHandler, NSAnimationDelegate, NSTextFinderClient, NSUserInterfaceValidations, NSWindowDelegate>
{
    ...
    NSButton *_largeAttachmentDontAskButton;
...
+ (id)autoSaveTimer;
+ (void)initialize;
@property(nonatomic) __weak NSButton *largeAttachmentDontAskButton; // @synthesize largeAttachmentDontAskButton=_largeAttachmentDontAskButton;
...
- (void)addSketchImageTagAttributes;
