...
- (void)openAllThreads;
- (void)closeThread:(id)arg1 focusRow:(long long)arg2 animate:(BOOL)arg3;
- (void)openThread:(id)arg1 andSelectMessage:(id)arg2 animate:(BOOL)arg3;
...
- (void)_preferNicknamesPreferenceChanged:(id)arg1;
