...
- (unsigned long long)_removeMessage:(id)arg1 fromMallArray:(id)arg2 sortValues:(id)arg3 inSortedRange:(struct _NSRange)arg4 usingComparator:(id)arg5 didRemove:(void)arg6;
- (id)_removeSortedMessages:(id)arg1 fromArray:(id)arg2 sortValues:(id)arg3 usingComparator:(id)arg4;
- (unsigned long long)_insertMessageIfAbsent:(id)arg1 intoMallArray:(id)arg2 sortValues:(id)arg3 inSortedRange:(struct _NSRange)arg4 usingComparator:(id)arg5 didInsert:(void)arg6;
- (id)_mergeSortedMessages:(id)arg1 intoArray:(id)arg2 sortValues:(id)arg3 usingComparator:(id)arg4;
...
- (void *)_secondarySortFunction;
- (void *)_primarySortFunction;
- (void *)_sortFunctionForSortOrder:(id)arg1;
- (id)_sortComparatorWithContext:(SEL)arg1 sortValues:(id)arg2;
...
- (unsigned long long)_indexOfChildMessage:(id)arg1 usingComparator:(id)arg2;
- (id)_getIndexesOfMessages:(id)arg1 completionBlock:(id)arg2;
- (void)getIndexesOfMessages:(id)arg1 completionBlock:(id)arg2;
- (id)_closeThreads:(id)arg1;
- (void)closeThreads:(id)arg1 animate:(BOOL)arg2;
- (id)_openThreads:(id)arg1;
- (void)openThreads:(id)arg1 animate:(BOOL)arg2;
...
- (id)_setStores:(id)arg1 sortOrder:(id)arg2 isSortedAscending:(BOOL)arg3 isInThreadedMode:(BOOL)arg4 viewingState:(id)arg5;
- (void)setStores:(id)arg1 sortOrder:(id)arg2 isSortedAscending:(BOOL)arg3 isInThreadedMode:(BOOL)arg4 viewingState:(id)arg5;
