...
@class DOMNode, EditableWebMessageDocument, MCInvocationQueue, MCParsedMessage, MFMailAccount, MFMailbox, NSArray, NSData, NSMutableArray, NSMutableDictionary, NSMutableSet, NSNumber, NSPort, NSString, NSURL, NSUUID, NSUndoManager, NSUserActivity, StationeryController;
...
@interface ComposeBackEnd : NSObject <ImageResizerDelegate, MCActivityTarget, NSStreamDelegate, NSUserActivityDelegate>
{
    ...
    NSData *_savedComposeData;
    long long _composeDataOffset;
...
@property(nonatomic) long long composeDataOffset; // @synthesize composeDataOffset=_composeDataOffset;
@property(retain, nonatomic) NSData *savedComposeData; // @synthesize savedComposeData=_savedComposeData;
