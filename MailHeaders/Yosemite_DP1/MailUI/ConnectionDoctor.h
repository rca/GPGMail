...
@class AccountStatusDataSource, NSArray, NSButton, NSDrawer, NSImageView, NSMutableString, NSProgressIndicator, NSString, NSTableView, NSTextField, NSTextView, NSView, NSWindow;
...
@property(retain, nonatomic) NSArray *savedLogClasses; // @synthesize savedLogClasses=_savedLogClasses;
