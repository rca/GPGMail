...
@class ActivityViewer, DeliveryQueue, DockCountController, DynamicErrorWindowController, FlagsMenuItemView, MailboxesController, NSMenu, NSMutableArray, NSMutableData, NSMutableSet, NSOutputStream, NSString, NSWindow;

@interface MailApp : NSApplication <IMAPUserAgent, MCUserAgent, MFUserAgent, MCActivityTarget, MVTerminationHandler, NSApplicationDelegate, NSMenuDelegate, NSStreamDelegate>
{
