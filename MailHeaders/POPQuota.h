...
- (void)deleteMessagesSheetDidEnd:(id)arg1 returnCode:(long)arg2 contextInfo:(void *)arg3;
- (BOOL)_shouldShowMessage:(id)arg1 showMessageType:(long)arg2;
- (id)_filterMessages:(id)arg1 showMessageType:(long)arg2;
