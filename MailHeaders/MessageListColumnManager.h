...
- (long)widthAndPosition:(int *)arg1 forColumn:(id)arg2 inTableView:(id)arg3 mailboxes:(id)arg4 isThreaded:(BOOL)arg5 isSearching:(BOOL)arg6;
- (long)widthAndPosition:(int *)arg1 forColumn:(id)arg2 mailboxes:(id)arg3 isThreaded:(BOOL)arg4 isSearching:(BOOL)arg5 locationIsVisible:(BOOL)arg6 rankIsVisible:(BOOL)arg7;
- (id)convertNormalSettingsFromPreleopardDefaults;
- (void)replaceColumn:(long)arg1 byColumn:(long)arg2 inSettings:(id)arg3;
- (void)setColumn:(long)arg1 isVisible:(BOOL)arg2 inSettings:(id)arg3;
...
- (BOOL)columnsList:(id)arg1 containsColumn:(long)arg2;
...
- (long)calcUnreadColumnWidth:(id)arg1 forUnreadCountString:(id)arg2;
