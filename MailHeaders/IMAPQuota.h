...
- (void)_updateQuotaBarWithSize:(unsigned long long)arg1 maxSize:(unsigned long long)arg2 count:(long)arg3 maxCount:(long)arg4;
...
- (id)_stringForSize:(unsigned long long)arg1 andCount:(long)arg2 isCapacity:(BOOL)arg3;
