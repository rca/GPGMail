...
+ (void)initialize;
+ (unsigned long long)_tableViewAnimationOptions:(unsigned long long)arg1;
...
- (void)deleteMessages:(id)arg1 allowMoveToTrash:(BOOL)arg2 allowUndo:(BOOL)arg3 withAnimationOptions:(unsigned long long)arg4;
...
- (BOOL)hideMessages:(id)arg1 selectingNextMessage:(BOOL)arg2 withAnimationOptions:(unsigned long long)arg3;
