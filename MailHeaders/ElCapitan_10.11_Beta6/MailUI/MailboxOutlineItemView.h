...
@class MailboxBadgeView, NSButton, NSObject<MailboxOutlineItemViewDelegate>, NSString, NSTrackingArea;
...
@interface MailboxOutlineItemView : NSTableCellView <NSTextFieldDelegate>
{
    ...
    NSTrackingArea *_addButtonTrackingArea;
}

@property(nonatomic) __weak NSTrackingArea *addButtonTrackingArea; // @synthesize addButtonTrackingArea=_addButtonTrackingArea;
