...
@class ConversationMember, NSArray, NSButton, NSImage, NSPopover, NSString, NSTextField;
...
@property(readonly, copy, nonatomic) NSString *bannerAddButtonText;
...
- (void)_showEventPopoverForRealtimeEvent:(id)arg1 sender:(id)arg2;
