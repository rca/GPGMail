...
@class CalUIDayViewGadgetController, EKEventViewController, NSLayoutConstraint, NSStackView, NSString, NSView, SGRealtimeEvent, SuggestedEventDayViewAppearanceDelegate;
