...
@class ABAddressBook, ABPerson, ABPersonView, NSLayoutConstraint, SGRealtimeContact;
...
@property(nonatomic) __weak ABPersonView *personView; // @synthesize personView=_personView;
