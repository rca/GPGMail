...
#import "MessageListControllerDelegate.h"
...
- (BOOL)deleteMessages:(id)arg1 allowMoveToTrash:(BOOL)arg2 allowUndo:(BOOL)arg3 withAnimationOptions:(unsigned long long)arg4;
...
- (void)deleteMessages:(id)arg1 allowingMoveToTrash:(BOOL)arg2 withAnimation:(unsigned long long)arg3;
