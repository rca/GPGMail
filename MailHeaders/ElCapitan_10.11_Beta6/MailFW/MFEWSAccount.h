...
+ (id)keyPathsForValuesAffectingURLExternalConnectionScheme;
+ (id)keyPathsForValuesAffectingURLInternalConnectionScheme;
+ (id)standardSSLPorts;
+ (id)standardPorts;
...
- (id)URLExternalConnectionScheme;
- (id)URLInternalConnectionScheme;
