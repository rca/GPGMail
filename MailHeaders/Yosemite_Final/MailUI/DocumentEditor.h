...
@class CALayer, ColorBackgroundView, ComposeBackEnd, ComposeStatusView, DeliveryFailure, EditingMessageWebView, EditingWebMessageController, HeadersEditor, LoadingOverlay, MCAttachment, MailInspectorBar, MailInspectorBarItemController, MailToolbar, MailWebViewEditor, MailWindowShadowLayer, MessageViewer, NSArray, NSButton, NSDictionary, NSMutableArray, NSMutableDictionary, NSOperation, NSOperationQueue, NSRunningApplication, NSStackView, NSString, NSTextField, NSTextFinder, NSUUID, NSView, NSTextFinderBarContainer, NSWindow, StationerySelector, TypeAheadWindow, WebArchive;
