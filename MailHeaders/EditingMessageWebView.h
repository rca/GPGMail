...
- (unsigned long)pastedGraphicCounter;
...
- (void)setSelectionStart:(id)arg1 offset:(int)arg2 end:(id)arg3 offset:(int)arg4 affinity:(unsigned long)arg5;
...
- (void)changeIndentation:(long)arg1;
...
- (long)compareRange:(id)arg1 toEndOfNode:(id)arg2;
