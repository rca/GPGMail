...
- (void)_confirmDownloadSheetDidEnd:(id)arg1 returnCode:(long)arg2 contextInfo:(id)arg3;
...
- (void)_confirmExecutableSheetDidEnd:(id)arg1 alertReturn:(long)arg2 context:(id)arg3;
...
- (long)_openFullPath:(id)arg1 withAppURL:(struct __CFURL *)arg2 options:(unsigned long)arg3;
- (void)_openPathsForAttachmentsWithDictionary:(id)arg1;
- (void)_chooseApplicationSheetDidEnd:(id)arg1 returnCode:(long)arg2 contextInfo:(id)arg3;
...
- (void)_savePanelSheetDidEnd:(id)arg1 returnCode:(long)arg2 contextInfo:(id)arg3;
- (void)_reportCantOpenSheetDidEnd:(id)arg1 returnCode:(long)arg2 contextInfo:(id)arg3;
