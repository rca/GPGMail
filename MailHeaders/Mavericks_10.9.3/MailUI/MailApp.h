...
@class ActivityViewer, ActivityViewerMailSound, DeliveryQueue, DockCountController, DynamicErrorWindowController, FlagsMenuItemView, MailAutoFetchManager, MailboxesController, NSMenu, NSMutableArray, NSMutableSet, NSString, NSWindow;
