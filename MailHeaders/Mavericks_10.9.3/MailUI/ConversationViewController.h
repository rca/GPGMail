...
@class ConversationMemberArrayController, ConversationView, ConversationViewFindController, NSDictionary, NSMutableDictionary, NSMutableIndexSet, NSMutableOrderedSet, NSUUID, UnfoldAnimationController;
...
@property(readonly, nonatomic) NSDictionary *messageViewingStateByLibraryID;
