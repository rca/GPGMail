...
@class AppleScriptPopUpButton, CriteriaUIHelper, MFMessageRule, MUIAddressField, MailboxesChooser, NSButton, NSMenu, NSMutableArray, NSPanel, NSPopUpButton, NSScrollView, NSTableView, NSTextField, NSTextView, NSView, SoundPopUpButton;
