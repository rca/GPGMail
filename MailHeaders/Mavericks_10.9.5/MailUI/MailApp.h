...
#import "MailAutoFetchManagerDelegate.h"
#import "NSApplicationDelegate.h"
#import "NSMenuDelegate.h"

@class ActivityViewer, ActivityViewerMailSound, DeliveryQueue, DockCountController, DynamicErrorWindowController, FlagsMenuItemView, MailAutoFetchManager, MailboxesController, NSMenu, NSMutableArray, NSMutableSet, NSString, NSTimer, NSWindow;

@interface MailApp : NSApplication <IMAPUserAgent, MCUserAgent, MFUserAgent, MailAutoFetchManagerDelegate, MCActivityTarget, MVTerminationHandler, NSApplicationDelegate, NSMenuDelegate>
{
    ...
    MailAutoFetchManager *_autoFetchManager;
}
...
@property(readonly, nonatomic) MailAutoFetchManager *autoFetchManager; // @synthesize autoFetchManager=_autoFetchManager;
...
@property(nonatomic) BOOL logAutoFetchTimerActivity;
