...
@interface MessageSelection : NSObject
{
    ...
    NSDictionary *_viewingState;
    NSArray *_messages;
}

@property(readonly, nonatomic) NSArray *messages; // @synthesize messages=_messages;
@property(readonly, nonatomic) NSDictionary *viewingState; // @synthesize viewingState=_viewingState;
...
- (void)dealloc;
- (id)_initWithInitialMessage:(id)arg1 conversations:(id)arg2 focusedMessagesByConversation:(id)arg3 selectedMessagesByConversation:(id)arg4 viewingState:(id)arg5 messages:(id)arg6;
- (id)initWithInitialMessage:(id)arg1 conversations:(id)arg2 selectedMessagesByConversation:(id)arg3 viewingState:(id)arg4 messages:(id)arg5;
