...
@property(copy, nonatomic) id commitEditingCompletionHandler; // @synthesize commitEditingCompletionHandler=_commitEditingCompletionHandler;
...
- (void)_commitEditingWithCompletionHandler:(id)arg1;
...
- (void)saveToMailbox:(id)arg1 forSaveOperation:(long long)arg2 completionHandler:(id)arg3;
- (void)writeToMailbox:(id)arg1 withOptions:(unsigned long long)arg2 completionHandler:(id)arg3;
- (void)messageWithOptions:(unsigned long long)arg1 completionHandler:(id)arg2;
- (void)readFromMailbox:(id)arg1 completionHandler:(id)arg2;
- (void)readFromMessage:(id)arg1 completionHandler:(id)arg2;
