...
@class NSAttributedString, NSButton, NSColor, NSImageView, NSLayoutConstraint, NSMutableArray, NSStackView, NSTextField, ThreadDisclosureTextField, _ToCCIndicator;
