...
@class DDActionContext, MUIWKViewController, MUIWebAttachmentController, NSArray, NSDraggingSession, NSEvent, NSString, WKProcessGroup;
...
@interface MUIWKView : WKView <NSDraggingDestination, NSDraggingSource, QLPreviewPanelDataSource, QLPreviewPanelDelegate, QLSeamlessCloserDelegate, QLSeamlessOpenerDelegate>
{
    ...
    MUIWebAttachmentController *_mouseOverAttachmentController;
    ...
    DDActionContext *_lastDataDetectorsContext;
    DDActionContext *_currentDataDetectorsContext;
}

@property(retain, nonatomic) DDActionContext *currentDataDetectorsContext; // @synthesize currentDataDetectorsContext=_currentDataDetectorsContext;
@property(retain, nonatomic) DDActionContext *lastDataDetectorsContext; // @synthesize lastDataDetectorsContext=_lastDataDetectorsContext;
...
@property(retain, nonatomic) MUIWebAttachmentController *mouseOverAttachmentController; // @synthesize mouseOverAttachmentController=_mouseOverAttachmentController;
