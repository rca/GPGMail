...
//- (void)splitView:(id)fp8 resizeSubviewsWithOldSize:(struct CGSize)fp12;
...
//- (void)draggedImage:(id)fp8 movedTo:(struct CGPoint)fp12;
...
//- (void)splitView:fp8 resizeSubviewsWithOldSize:(struct CGSize)fp12;
...
//- (void)draggedImage:fp8 movedTo:(struct CGPoint)fp12;
//- (void)draggingUpdatedAtLocation:(struct CGPoint)fp8;
